...
// @gen:known_bosses:start
  "adentus": "field_boss",
  "adentus's ghost": "boss",
  "agile ogre spy": "boss",
  "ahzreil": "field_boss",
  "ahzreil's ghost": "boss",
  "akman": "boss",
  ...
  "avolos umbramancer": "boss",
  "berge": "boss",
  "berserk dark enforcer": "boss",
  "berserk shade wizard": "boss",
  ...
  "chernobog's ghost": "boss",
  "chief orc gatekeeper": "boss",
  "chief sandworm": "boss",
  "chief terror bird": "boss",
  "contaminated mitran chief": "boss",
  "cornelius": "field_boss",
  "cornelius's ghost": "boss",
  "corrupt spectral wizard": "boss",
  "daigon": "boss",
  "dancing giant butcher": "boss",
  "deathless skeleton commander": "boss",
  "deckman": "boss",
  "deluzhnoa": "archboss",
  "demonhoof head shaman": "boss",
  ...
  "dwarf commander": "boss",
  "eccentric gourmand": "boss",
  "elite grinding golem": "boss",
  "elleia": "boss",
  "embergourd": "boss",
  "enchanted evil eye sentry": "boss",
  "evil eye sentry": "boss",
  ...
  "fire orc brawler chief": "boss",
  "flame desert wizard": "boss",
  "frenzied ancient weapon": "boss",
  "frenzied red pyromancer": "boss",
  "frosteye watcher": "boss",
  "gaitan": "dungeon_boss",
  "gaudian": "boss",
  ...
  "giant crystal scorpion": "boss",
  "giant goblin butcher": "boss",
  "giant goblin slaughterer": "boss",
  "giant gray lycan butcher": "boss",
  "giant monstrous wraith": "boss",
  "giant ravenous zombie": "boss",
  "gnoller": "boss",
  "goblin butcher": "boss",
  "grand aelon": "field_boss",
  "grand aelon's ghost": "boss",
  "grayclaw giant butcher": "boss",
  "grayeye": "dungeon_boss",
  "grimturg": "boss",
  "guard captain": "boss",
  "guardian of the ancient forest": "boss",
  "hammer marshark": "boss",
  "havres": "boss",
  "haylock": "boss",
  "heliber": "dungeon_boss",
  "icebone commander": "boss",
  "immortal guardian": "boss",
  "incomplete giant goblin": "boss",
  "infiltration captain": "boss",
  "junobote": "field_boss",
  ...
  "king chimaerus's ghost": "boss",
  "king khanzaizin": "boss",
  "king verte": "boss",
  "knight captain ranvier": "boss",
  "kowazan": "field_boss",
  "lacune": "dungeon_boss",
  "lavelle": "boss",
  "lazarus ghost": "boss",
  ...
  "mitran chief": "boss",
  "molgras": "boss",
  "monstrous wraith": "boss",
  "morokai": "field_boss",
  "morokai's ghost": "boss",
  "murdock": "boss",
  "mutant beast": "boss",
  "mutant chef": "boss",
  "mutant killer": "boss",
  ...
  "orc brawler chief": "boss",
  "orc shadow elder": "boss",
  "pakilo naru": "field_boss",
  "pirate king's chest crab": "boss",
  "porfos": "boss",
  "queen bellandir": "archboss",
  "queen blood spider": "boss",
  "quente, executor of the seal": "boss",
  "radeth": "archboss",
  "reptilian butcher": "boss",
  ...
  "shiwatuki": "boss",
  "shrouded knight-master golem": "boss",
  "silent gatekeeper vahelon": "boss",
  "snowfield armored warrior": "boss",
  "snowfield flame wizard": "boss",
  ...
  "vulcanus": "boss",
  "vulkan": "archboss",
  "water golem commander": "boss",
  "white beard ogre shaman": "boss",
  "wraith harbinger": "boss",
  "zairos": "archboss",
  "zarek": "boss",
  "zaroth": "boss",
